"""Correlation of inter-temporal dependencies"""
...
base = Path.cwd()
cur_path = base /'Experiments/Experiment1/'
...
plt.title(f'inter_temp_corr')
plt.savefig(cur_path/'Outputs/inter_temp_corr.png')
plt.show()
